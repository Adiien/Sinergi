...
<body class="pt-20 pb-10">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200 mb-6">
        ...
        <div class="h-48 md:h-80 w-full relative bg-gray-200 overflow-hidden group">
        ...
        <div class="container mx-auto px-4 lg:px-8 pb-6">
            <div class="relative -mt-16 flex flex-col md:flex-row items-end md:items-end justify-between gap-6">

                <div class="flex items-end gap-6 w-full md:w-auto relative z-10">

                    <div class="w-32 h-32 md:w-40 md:h-40 rounded-3xl ring-4 ring-white shadow-xl overflow-hidden bg-white flex-shrink-0 flex items-center justify-center">
                        <?php
                        // Opsi: Jika ingin Icon tetap menggunakan Cover Image (versi kecil), uncomment baris bawah
                        // dan comment bagian 'div' inisial. Tapi biasanya Cover = Banner.
                        /* if (!empty($forum['COVER_IMAGE'])): ?>
                ...
                <div class="flex items-center gap-3 w-full md:w-auto mt-4 md:mt-0 md:mb-3">
                    ...
                    <?php else: ?>
                        <button class="bg-indigo-600 text-white hover:bg-indigo-700 font-bold py-2.5 px-6 rounded-xl transition shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                            Join Group
                        </button>
                    <?php endif; ?>
                </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden sticky top-24">
                    ...
                    <nav class="flex flex-col py-2">
                        <a href="#" class="flex items-center px-6 py-4 bg-blue-50 border-l-4 border-blue-600 text-blue-700 font-bold transition">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
                            </svg>
                            Feed
                        </a>
                        <a href="#" class="flex items-center px-6 py-4 text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium transition">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
